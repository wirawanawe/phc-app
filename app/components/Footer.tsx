    ...
    <footer className="bg-[#E32345] text-white py-8 hidden md:block">
      <div className="container mx-auto px-4">
        ...
        <div className="mt-6 flex justify-center space-x-6">
          ...
          {settings?.facebook ? (
            <a
              ...
              className="text-gray-300 hover:text-[#1877F2] transition-colors duration-300 transform hover:scale-110"
              aria-label="Facebook"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          {settings?.twitter ? (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-300 hover:text-[#1DA1F2] transition-colors duration-300 transform hover:scale-110"
              aria-label="Twitter"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          {settings?.instagram ? (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-300 hover:text-[#E1306C] transition-colors duration-300 transform hover:scale-110"
          ...
          {settings?.youtube ? (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-300 hover:text-[#FF0000] transition-colors duration-300 transform hover:scale-110"
              aria-label="YouTube"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        {!settings?.facebook &&
          ...
          !settings?.instagram &&
          !settings?.youtube && (
            <p className="text-center text-xs text-gray-500 mt-2"></p>
          )}
      </div>
    </footer>
  );
